...
const CryptoJS = (cryptoJs?.default || cryptoJs);
...
form.onsubmit = (e) => {
    ...
    const access_key_secret = formdata.get('AccessKeySecret');
 ...
 * @returns
 */
function getSignature(accessKeySecret) {
